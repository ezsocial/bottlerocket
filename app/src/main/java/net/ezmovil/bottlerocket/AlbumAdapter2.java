...
public class AlbumAdapter2 extends RecyclerView.Adapter<AlbumAdapter2.MyViewHolder> {
    ...
    private List<net.ezmovil.bottlerocket.Album2> albumList;
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.overflow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                infoWeatherImage _infoWeatherImage = new infoWeatherImage();
                _infoWeatherImage.setTxt(holder.uri.getText().toString());
                _infoWeatherImage.setName(holder.title.getText().toString());
                _infoWeatherImage.setGeonameid(holder.count.getText().toString());
